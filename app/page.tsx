            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Each variant has its own optimized grid size and animation pattern.
                </p>
                <div className="grid gap-4 lg:grid-cols-2">
                  <div className="flex items-center justify-center gap-6 p-8 rounded-xl border bg-muted/30 flex-wrap">
                    <div className="text-center">
                      ...
                      <span className="block mt-3 text-xs text-muted-foreground">breathe</span>
                    </div>
                    <div className="text-center">
                      <BrailleLoader variant="rain" />
                      <span className="block mt-3 text-xs text-muted-foreground">rain</span>
                    </div>
                    <div className="text-center">
                      <BrailleLoader variant="helix" />
                      <span className="block mt-3 text-xs text-muted-foreground">helix</span>
                    </div>
                    <div className="text-center">
                      <BrailleLoader variant="snake" />
                      <span className="block mt-3 text-xs text-muted-foreground">snake</span>
                    </div>
                  </div>
                  <CodeBlock code={`<BrailleLoader variant="breathe" />
<BrailleLoader variant="rain" />
<BrailleLoader variant="helix" />
<BrailleLoader variant="snake" />`} language="tsx" />
                </div>
              </div>
